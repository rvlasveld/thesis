...
\subsection{Summary}
This survey tooks a look at different methodologies that perform outlier detection.
...
\begin{description}
  ...
  \item[Type 3] - Model only normal data (and in very few cases abnormal). Generally refered to as \emph{novelty detection}, analogous to \emph{semi-supervised recognition or detection}. It only requires pre-classified normal data. It aims to define a boundary of normality.
\end{description}
