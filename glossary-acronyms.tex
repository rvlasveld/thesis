...
\newacronym{almende-data}{ACRAS}{Almende Continuous Real-world Activities with on-body smartphones Sensors Data Set}
...
\newacronym{uci-har}{UCI HAR}{Human Activity Recognition Using Smartphones Data Set}
...
\newacronym{ocs-hats}{OCS-HATS}{One-Class \gls{svm} Human Activity Temporal Segmentation}
