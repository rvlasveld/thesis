...
Finally, in \Cref{sec:change_detection_methods} we discuss two different, but simple, methods to detect changes in the time series data, based on the extracted radius $R$.
