...
\end{figure}
*** Add wikipedia reference. How to do? http://en.wikipedia.org/wiki/File:Svm_max_sep_hyperplane_with_margin.png ***
...
\end{figure}
*** Add wikipedia reference. How to do? http://en.wikipedia.org/wiki/File:Kernel_Machine.png ***
