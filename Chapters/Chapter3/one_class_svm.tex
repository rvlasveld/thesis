...
\end{equation}
\TODO{Elaborate on imporant properties of page 56, in Appendix A: maximum-margin is searching for support vectors and pairwise dot products, Kernel matrix.}
...
``Continuity assumptions: This is a general assumption in pattern recognition: two objects near in feature space should also resemble each other in real life'' \cite{tax2001one}.
...
Kernels for Support Vector Classifiers were first (?) used by Vapnik \cite{vapnik1998statistical}. \\
