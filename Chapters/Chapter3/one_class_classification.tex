...
\TODO{Add ref to \cite{hodge2004survey}, which states 3 types of outlier detection. It puts \gls{occ} as of Type 3: \textbf{semi-supervised recognition or detection}}
...
This measure is related to other similarity measures, such as \gls{pdf} estimation and the \gls{kl} divergence as discussed in \Cref{subsec:change_detection_problem_formulation}.
