...
This measure is related to other similarity measures, such as \gls{pdf} estimation and the \gls{kl} divergence as discussed in \Cref{sec:change_detection_time_series}.
