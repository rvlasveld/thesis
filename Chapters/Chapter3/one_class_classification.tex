...
\TODO{Introduce problem of \gls{occ}. Relate to two-class classification.}
...
\TODO{Add reference to~\ref{subsec:change_detection_problem_formulation} which also mentions \gls{kl} divergence?}
