...
*** Give the problem of change definition. Follow definition of Camci \cite{camci2010change} ***

*** Note: the following block is copied from \ref{sec:method_change_indication} *** \\
