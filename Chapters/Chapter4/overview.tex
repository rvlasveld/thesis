...
\begin{figure}
  ...
  \caption[Method setup]{Schematic representation of the change detection method. \TODO{Gerard noemt dit misschien ook goed voor bij de inleiding, als motivatie voor onderzoek. Overnemen?}}
...
As graphically represented in \Cref{fig:method_overview}, the change detection method starts by processing the data from sensor, such as the accelerometer, magnetic orientation and rotation measures \footnote{Something about the origin of the streams; all from the same sensor or different sensors?}.
