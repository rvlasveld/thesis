...
The following section will discuss the features extracted from the constructed \gls{oc-svm} model at every loop-step of the algorithm, before \Cref{sec:method_change_detection} describes how these features are used to detect change.