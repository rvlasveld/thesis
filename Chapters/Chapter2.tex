...
\Cref{sec:svm_in_change_detection} discusses the \gls{svm}-methods.
...
% \Cref{dim-reduction} discuses this method.
...
In \Cref{sec:change_detection_methods} we will give an overview of those kind of algorithms.
An often encountered problem is the \emph{curse of dimensionality}.
To overcome this problem, we look at \gls{dr} methods in \Cref{sec:dimensionality_reduction}.
