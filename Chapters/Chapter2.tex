...
The next section, \Cref{sec:literature_review_temporal_segmentation} follows the distinction made and looks at a collection of temporal segmentation and change detection methods.
