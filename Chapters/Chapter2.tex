...
clusters, which are a representation of the data examined, can be used in the 
...
and each segment will be labeled with a activity. An other mechanism could be 
...
The most critical step, the \emph{grouping},
