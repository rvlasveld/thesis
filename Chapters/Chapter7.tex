...
From these methods we have created our own method \gls{ocs-hats} and made it puclibly available \cite{vlasveld2014hats}, which is a slightly modified implemention of \gls{svcpd} by Camci~\cite{camci2010change} applied to \gls{har} data.
